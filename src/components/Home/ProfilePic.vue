...
<template>
  <div class="profile">
    ...
    <img class="profile-img" src="https://pbs.twimg.com/media/F1XfkylakAAz5fs.jpg:large" alt="..." />
    <div class="dots-1">
      <!-- SVG Dots-->
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        viewBox="0 0 191.6 1215.4" style="enable-background: new 0 0 191.6 1215.4" xml:space="preserve">
